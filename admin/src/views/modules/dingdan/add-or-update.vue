    ...
    >
      <el-row>
        ...
        <el-form-item  v-if="type!='info'"  label="骑手收益" prop="qishoushouyi">
          <el-input :value="qishouIncome"
              readonly
              placeholder="骑手收益"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.qishoushouyi" label="骑手收益" prop="qishoushouyi">
              <el-input :value="qishouIncome" 
                placeholder="骑手收益" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="type!='info'" label="下单时间" prop="xiadanshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiadanshijian" label="下单时间" prop="xiadanshijian">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.lockPrice = (type === 'cross') || this.$storage.get('role') === '用户'
      if(this.type=='info'||this.type=='else'){
        ...
        this.ruleForm.caipinid = obj.id
        this.ruleForm.qishoushouyi = this.qishouIncome
                                                                                                                                                                                                                                                                                                                              }
            // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      this.ruleForm.qishoushouyi = this.qishouIncome
      if(!this.ruleForm.caipinid && this.$storage.getObj('crossObj')){
        this.ruleForm.caipinid = this.$storage.getObj('crossObj').id
      }
      if(!this.ruleForm.goumaishuliang || this.ruleForm.goumaishuliang<1){
        this.ruleForm.goumaishuliang = 1
      }
                              // ${column.compare}
                              // ${column.compare}
                              // ${column.compare}
