        ...
        <el-table
            ...
            <el-table-column
              ...
              <el-table-column
                  ...
                  label="订单状态">
                  <template slot-scope="scope">
                    <span style="margin-right:10px">{{scope.row.sfsh || '待接单'}}</span>
                    <el-button  type="text" icon="el-icon-edit" size="small" @click="shDialog(scope.row)">更新状态</el-button>
                  </template>
              </el-table-column>
                        <el-table-column
                header-align="center"
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
      ...
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="订单状态">
          <el-select v-model="shForm.sfsh" placeholder="订单状态">
